...
const TopSideButtons = () => {
    ...
    const { openModal, closeModal } = useModelStore();
   

    const openAddNewLeadModal = () => {
        // dispatch(openModal({ title: "Add New Lead", bodyType: MODAL_BODY_TYPES.LEAD_ADD_NEW }));
        openModal({ title: "Add New Lead", bodyType: MODAL_BODY_TYPES.LEAD_ADD_NEW, isOpen: true });
    };
...
function Leads() {
    const { leads, addNewLead, deleteLead, getLeads } = useLeadStore();
    const { openModal, closeModal } = useModelStore();
    ...
    const deleteCurrentLead = (index: number) => {
        ...
        openModal({ title: "Confirmation", bodyType: MODAL_BODY_TYPES.CONFIRMATION, extraObject: { message: `Are you sure you want to delete this lead?`, type: CONFIRMATION_MODAL_CLOSE_TYPES.LEAD_DELETE, index }, isOpen: true});
    };
